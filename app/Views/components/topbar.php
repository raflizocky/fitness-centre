...
>
  ...
  >
    ...
    >
      ...
      <a href="<?= $baseUrl ?>index.html" class="lg:hidden">
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= $baseUrl ?>src/images/user/user-02.jpg"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= $baseUrl ?>src/images/user/user-03.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= $baseUrl ?>src/images/user/user-04.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="<?= $baseUrl ?>src/images/user/user-05.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="<?= $baseUrl ?>src/images/user/owner.jpg" alt="User" />
          </span>
